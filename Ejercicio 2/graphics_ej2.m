...
plot(t_NP, pos_cart_NP(:,3), 'g-', 'LineWidth', 1.5);
grid on;
xlabel('Tiempo (s)', 'FontSize', 12);
...
plot(t_P, pos_cart_P(:,3), 'g-', 'LineWidth', 1.5);
grid on;
xlabel('Tiempo (s)', 'FontSize', 12);
ylabel('Posición (m)', 'FontSize', 12);
title('Robot PERTURBADO (80%)', 'FontSize', 14, 'FontWeight', 'bold');
...
rob.plot(q_NP, 'trail', 'b-', 'workspace', [-1 3 -1 3 -1 2]);
title('Robot NO PERTURBADO', 'FontSize', 14, 'FontWeight', 'bold');
grid on;
...
rob2.plot(q_P, 'trail', 'r-', 'workspace', [-1 3 -1 3 -1 2]);
title('Robot PERTURBADO (80%)', 'FontSize', 14, 'FontWeight', 'bold');
grid on;
